...
def test_github():
    gth = GitHubClient(owner="octocat", repository="Hello-World", revision="7fd1a60b01f91b314f59955a4e4d4e80d8edf11d",
                       sha256="39a4b97b9d108782fa7466b07160a2c9227a7da07725ad4110c41be6014e4160", testing=True)
    gth.unpack()
...
def test_github_fail():
    gth = GitHubClient(
        ...
        sha256="cc82fedd92d6fd783c9c6f984e4a67daa6c03f783e47016ba3610691b542df91", testing=True)  # last should be 2
...
def test_github_download_fail():
    gth = GitHubClient(
        ...
        sha256="cc82fedd92d6fd783c9c6f984e4a67daa6c03f783e47016ba3610691b542df92", testing=True)
