...
def test_github_fail():
    gth = GitHubClient(owner="octocat", repository="Hello-World", revision="553c2077f0edc3d5dc5d17262f6aa498e69d6f8e",
...
def test_github_download_fail():
    gth = GitHubClient(owner="octocat", repository="Hello-World2", revision="553c2077f0edc3d5dc5d17262f6aa498e69d6f8e",
                       sha256="cc82fedd92d6fd783c9c6f984e4a67daa6c03f783e47016ba3610691b542df91")  # last should be 2
